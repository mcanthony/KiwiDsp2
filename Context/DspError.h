...
namespace Kiwi
{
    ...
    public:
         ...
         */
        DspError(scDspLink _link, Type const& _type) noexcept : type(_type), link(_link)
        {
            ;
        }
    ...
    public:
         ...
         */
        DspError(sDspNode node1, sDspNode node2, Type const& type) noexcept : m_type(type), m_first(node1), m_second(node2)
        {
            ;
        }
        //! Destructor.
